...
// }
    ...
    */
    ...
    if( (query.mylat) && (query.mylon)) {
        ...
        select_sql = "SELECT a.*, 0 AS distance FROM pharmacy a "
    }
    ...
    // 검색조건이 있을경우
    if( query.addr || query.avalpharmacy || query.avalday || query.avalholiday  || query.avalnight || ((query.mylat) && (query.mylon))) {
        select_sql += 'WHERE ';
    }
